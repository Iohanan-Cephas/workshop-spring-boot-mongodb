package com.jpob.workshopmongo.resources;
...
import com.jpob.workshopmongo.services.UserService;
...
public class UserResource {
	...
	public ResponseEntity<Void> insert(@RequestBody UserDTO obj) {
		User obj2 = service.fromDTO(obj);
		obj2 = service.insert(obj2);
