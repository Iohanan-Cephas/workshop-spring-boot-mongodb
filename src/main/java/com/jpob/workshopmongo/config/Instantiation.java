package com.jpob.workshopmongo.config;
...
import com.jpob.workshopmongo.dto.AuthorDTO;
import com.jpob.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		CommentDTO c3 = new CommentDTO("tenha um ótimo dia.", sdf.parse("22/03/2024"), new AuthorDTO(bob));
